...
%{
TO DO:
-Increase the size of all legend text
-Shrink vertical size of dendrite
-switching capacitive and NMDA colors, so both synaptic currents are blue, and the NMDA gets a more salient color
-Contextual voltage chart.
...
annotation('textbox',[.36 BoxMinLine-.03 .04 .04],...
           'String', 'Proximal',...
           'LineStyle', 'none',...
           'VerticalAlignment', 'bottom');
...
annotation('rectangle',...
        [LegendStart+.03 .49 .9*SpaceConstant .02],...    
        'LineWidth', .0001, ...
        'FaceColor', [.2 .1 .1]);
